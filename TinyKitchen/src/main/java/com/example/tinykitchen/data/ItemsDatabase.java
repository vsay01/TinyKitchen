...
import static com.example.tinykitchen.data.ItemsProvider.Tables;

public class ItemsDatabase extends SQLiteOpenHelper {
    private static final String DATABASE_NAME = "tintykitchen.db";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " + Tables.ITEMS + " ("
                ...
                + ItemsContract.ItemsColumns.ARTICLE_REFERENCE + " TEXT NOT NULL"
                + ")" );
    }
