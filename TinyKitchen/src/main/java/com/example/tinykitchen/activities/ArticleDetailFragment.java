...
import com.example.tinykitchen.widgets.ObservableScrollView;
...
public class ArticleDetailFragment extends Fragment implements
    ...
    private void bindViews() {
        ...
        footerView.setPaintFlags(footerView.getPaintFlags() |   Paint.UNDERLINE_TEXT_FLAG);
        ...
        if (mCursor != null) {
            ...
            footerView.setText("References: "+mCursor.getString(ArticleLoader.Query.ARTICLE_REFERENCE));
            footerView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ((ArticleDetailActivity)getActivity()).openCustomTab(mCursor.getString(ArticleLoader.Query.ARTICLE_REFERENCE));
                }
            });
